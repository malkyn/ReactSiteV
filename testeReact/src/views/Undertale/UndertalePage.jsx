...
import imageEshow from '../../assets/images/eshowslogo.png'
import imageHorizon from '../../assets/images/horizon200.jpg'
                 ...
                 <div className={style.pageContent}>
                    ...
                    <div className={styleCard.container}>
                        ...
                        <div className={styleCard.card}>
                            ...
                            <h1 className={styleCard.cardTitle}>Eshows</h1>
                            <p className={styleCard.cardText}>A maior plataforma de música ao vivo do Brasil!</p>
                        </div>
                        <div className={styleCard.card}>
                            <img className={styleCard.cardImage} src={imageHorizon} alt="EshowsLogo" />
                            <h1 className={styleCard.cardTitle}>Horizon</h1>
